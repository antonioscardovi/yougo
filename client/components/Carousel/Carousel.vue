<template>
  ...
  <form class="crsl">
			...
			<input type="radio" name="cars" autofocus value="vehicle1" id="vehicle1" />
			<!-- <input type="radio" name="fancy" value="hearts" id="hearts" /> -->
			<input type="radio" name="cars" value="vehicle2" id="vehicle2" />
			<!-- <input type="radio" name="fancy" value="spades" id="spades" /> -->
			<input type="radio" name="cars" value="vehicle3" id="vehicle3" />
			<!-- <input type="radio" name="fancy" value="diamonds" id="diamonds" /> -->
			<input type="radio" name="cars" value="vehicle4" id="vehicle4" />
			...
			<label for="vehicle1">&#9827; Clubs</label><label for="vehicle2">&#9829; Hearts</label><label for="vehicle3">&#9824; Spades</label><label for="vehicle4">&#9830; Diamonds</label>

			<div class="keys">Pregledajte Aute</div>
	</form>
  </section>
</template>
